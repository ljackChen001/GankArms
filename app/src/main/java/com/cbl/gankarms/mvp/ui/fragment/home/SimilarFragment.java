...
import com.cbl.gankarms.di.component.DaggerSimilarComponent;
...
public class SimilarFragment extends BaseFragment<SimilarPresenter> implements SimilarContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerSimilarComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .similarModule(new SimilarModule(this))
                .build()
                .inject(this);
