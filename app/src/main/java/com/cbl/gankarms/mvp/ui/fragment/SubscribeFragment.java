...
import com.cbl.gankarms.di.component.DaggerSubscribeComponent;
import com.cbl.gankarms.di.module.SubscribeModule;
import com.cbl.gankarms.mvp.contract.SubscribeContract;
import com.cbl.gankarms.mvp.presenter.SubscribePresenter;
...
public class SubscribeFragment extends BaseFragment<SubscribePresenter> implements SubscribeContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerSubscribeComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .subscribeModule(new SubscribeModule(this))
                .build()
                .inject(this);
    }
